...
class CategoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    log('categories');
    final provider =
        Provider.of<NewsCategoryListProvider>(context, listen: false);
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Consumer<NewsCategoryListProvider>(
                        builder: (context, pro, _) {
                      return Container(
                        decoration: BoxDecoration(
                            color: pro.categoryName == pro.categoriesList[index]
                                ? Colors.blue
          ...
          Consumer2<NewsCategoryListProvider, NewsProvider>(
              builder: (context, provi, newsView, _) {
            return Expanded(
              child: FutureBuilder<NewsModel>(
                future: newsView.fetchCategory(provi.categoryName),
